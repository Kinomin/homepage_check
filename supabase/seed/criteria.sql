...
insert into criteria (
  ...
  ('B2', 'B', '探究学習', '保護者・塾', '生徒が自ら課題を設定して調査・考察し発表する活動（探究・課題研究・論文・ゼミ等）の紹介があるか。名称は学校ごとに全く異なるため、名称ではなく活動内容で判定すること。独立した紹介ページがあり、取り組みの流れや生徒のテーマが分かれば full。行事一覧に発表会名があるだけなら thin。', ARRAY['探究学習', '自調自考論文', '総合学習', '総合的な学習の時間', '探究コース', '課題研究', 'ゼミ']::text[], ARRAY['/education', '/inquiry', '/research', '/study', '/program']::text[], null, null, 4),
